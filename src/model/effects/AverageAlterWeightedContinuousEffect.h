 ...
 *
 * File: AverageAlterWeightedContinuousEffect.h
 *
...
#ifndef AVERAGEALTERWEIGHTEDCONTINUOUSEFFECT_H_
#define AVERAGEALTERWEIGHTEDCONTINUOUSEFFECT_H_
 ...
 */
class AverageAlterWeightedContinuousEffect : public NetworkDependentContinuousEffect
{
public:
	AverageAlterWeightedContinuousEffect(const EffectInfo * pEffectInfo);
