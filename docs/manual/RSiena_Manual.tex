...
This version was renewed for \RS version 1.6.6.
...
\item[Check your version of \RS]
  ...
  The version is
  identified by a version number (e.g.\ 1.6.6).
...
\verb|R CMD check RSiena_1.6.6.tar.gz|\\
...
to others, type\\
\verb|R CMD INSTALL --build RSiena_1.6.6.tar.gz| \\
