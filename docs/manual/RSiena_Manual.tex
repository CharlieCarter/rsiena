...
This version was renewed for \RS version1.6.7.
...
\item[Check your version of \RS]
  ...
  The version is
  identified by a version number (e.g., 1.6.7).
...
\verb|R CMD check RSiena_1.6.7.tar.gz|\\
...
to others, type\\
\verb|R CMD INSTALL --build RSiena_1.6.7.tar.gz| \\
