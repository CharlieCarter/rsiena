...
This version was renewed for \RS version1.6.8.
...
\item[Check your version of \RS]
  ...
  The version is
  identified by a version number (e.g., 1.6.8).
...
\verb|R CMD check RSiena_1.6.8.tar.gz|\\
...
to others, type\\
\verb|R CMD INSTALL --build RSiena_1.6.8.tar.gz| \\
...
\item 2026-06-06 GitHub, package version 1.6.8.
...
\begin{itemize}
  ...
  \item Hidden option to use the one-step estimator with 
      \texttt{prevAns} in \sfn{siena}.
  \item \sfn{print.sienadata} now specifies the node sets for covariates
